...
import chefFullImg from '@/public/images/chef-full.webp';

import { Formik, Form } from 'formik';
import { login } from '@/src/app/utils/yup/schema';
import FormikControl from '@/src/app/utils/form/FormikControl';
import { loginUser, registerNewUser } from '@/src/app/utils/auth/Auth';
          ...
          <Form className='mt-28'>
            <div className='mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4'>
              <div className='w-2/5'>
                ...
                <div className='my-5'>
                  <a href='/pages/auth/forget' className='my-5'>
                ...
                <a href='/pages/auth/register' className='my-5 font-bold'>
                  New to CookMate?
                </a>
              </div>
              <div className='mt-16 w-2/5 self-start'>
                <Image src={chefFullImg} width={500} alt='Chef' />
              </div>
            </div>
          </Form>
        )}
